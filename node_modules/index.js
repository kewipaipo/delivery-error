let cart = [];
    ...
    function placeOrder() {
        ...
        console.log(orderDetails); // Здесь можно отправить данные на сервер или использовать в своем приложении
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        let now = new Date();
        now.setHours(now.getHours() + 1); // Добавляем час к текущему времени
        let minTime = now.toISOString().slice(0, 16); // Форматируем дату в строку формата 'YYYY-MM-DDTHH:MM'
